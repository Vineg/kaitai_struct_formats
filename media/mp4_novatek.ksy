meta:
  ...
  file-extension: mp4
  endian: be
  doc-ref: https://sergei.nz/extracting-gps-data-from-viofo-a119-and-other-novatek-powered-cameras/
  ...
  gps_index:
    seq:
      ...
      - id: entries_cnt
        type: u4
      - id: entries
        type: gps_index_entry
        repeat: expr
        repeat-expr: entries_cnt
